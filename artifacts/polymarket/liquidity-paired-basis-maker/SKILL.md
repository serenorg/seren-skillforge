...
1. `load_backtest_pairs` pulls live market histories through the local Polymarket CLI adapter, applies a liquidity-filtered universe cap, builds pairs, and timestamp-aligns each pair.
